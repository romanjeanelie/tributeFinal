...
void main()	{
  ...
  float step0 = smoothstep(threshold0, threshold0 + size0 *2. , vUv.y  +  size0 ) - smoothstep(threshold0 - size0/1.,threshold0, vUv.y - size0  * animColors);
